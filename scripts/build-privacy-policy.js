...
/**
 * Converts docs/privacy-policy.md to a standalone HTML page for GitHub Pages.
 * Output: _site/privacy/index.html
 *
 * Uses the same minimal markdown-to-HTML converter as build-user-guide.js.
 */
...
<head>
  ...
  <title>In Due Time — Privacy Policy</title>
  <style>
...
const outDir = path.join(__dirname, "..", "_site", "privacy");
fs.mkdirSync(outDir, { recursive: true });
fs.writeFileSync(path.join(outDir, "index.html"), html);
console.log("Built _site/privacy/index.html");
